...
class OwnerController extends Controller
{
    ...
    public function rejectCustomerReturn(Request $request, CustomerReturn $return): RedirectResponse
    {
        $request->validate(['notes' => ['required', 'string']]);
        $return->update([
            'status' => 'REJECTED',
    ...
    public function rejectStockWriteoff(Request $request, StockWriteoff $writeoff): RedirectResponse
    {
        $request->validate(['notes' => ['required', 'string']]);
        $writeoff->update([
            'status' => 'REJECTED',
