<div>
    ...
    <style>
        ...
        .badge-inprogress { background: #dbeafe; color: #206bc4; font-size: 0.75rem; padding: 2px 8px; border-radius: 20px; white-space: nowrap; }
    ...
    <div class="px-3 mb-1">
        <div class="falaya-card falaya-card--warning p-3 d-flex align-items-center gap-2 mb-0">
            ...
            <div class="flex-grow-1">
                ...
                <div style="font-size:0.8rem;color:#92400e">Ketuk untuk coba kirim ulang</div>
            </div>
        ...
        <div class="falaya-card p-3 mb-0">
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="flex-grow-1">
                    ...
                    <div style="font-size:0.8rem;color:#206bc4;margin-top:2px">{{ $visitInProgress }} sedang berlangsung</div>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="px-3 mb-3">
        <div class="section-label">📦 Stok Bawaan</div>
        <div class="falaya-card p-3 mb-0">
            ...
            <div class="d-flex justify-content-between align-items-center {{ !$loop->last ? 'mb-2 pb-2 border-bottom' : '' }}">
                ...
                <div style="font-size:1rem;font-weight:700;color:{{ $item['qty'] <= 5 ? '#d63939' : '#1a1a2e' }}">
                    ...
                    <span style="font-size:0.7rem;color:#d63939"> ⚠️</span>
                    @endif
                </div>
            </div>
            @endforeach
    ...
    @else
    <div class="px-3 mb-3">
        <div class="falaya-card falaya-card--info p-3 text-center mb-0">
            <div style="font-size:2rem;margin-bottom:8px">🎉</div>
            <div style="font-weight:600;color:#1e40af">Semua kunjungan selesai!</div>
            <div style="font-size:0.85rem;color:#3b5ea6;margin-top:4px">Kerja bagus hari ini.</div>
        </div>
    </div>
    @endif
